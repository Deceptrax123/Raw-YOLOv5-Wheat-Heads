...
from wheat_dataset import Wheat_Head_Dataset
import numpy as np
...
if __name__=='__main__':
    ...
    image_paths=os.listdir("/Volumes/T7 Shield/Smudge/Datasets/Wheat_Head_detection/test/")
    ...
    dataset=Wheat_Head_Dataset(image_paths)

    wandb.init(
        project="space-exploration-wheats",
        config={
            "learning_rate":0.0002,
            "architecture":"GAN",
            "dataset":"Wheat Head Dataset AICROWD",
            "Epochs":300,
        },
    )
    ...
    train_steps=(len(image_paths)+params['batch_size']-1)//params['batch_size']
